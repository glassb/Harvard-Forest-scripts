...
test <- RasterClipbyFFP("FFP.hr.lines.96.11.csv",307,.75,"Lidar_CHM_2019.tif","/Users/benjaminglass/Desktop/HF21/00_Datasets/00-spatial-deliverables/LIDAR_CHM_rasters")
...
RasterClipbyFFP("FFP.hr.lines.96.11.csv",309,.75,"SoilDrainage(0-ND)_utm.tif","/Users/benjaminglass/Desktop/HF21/00_Datasets/00-spatial-deliverables/SoilDrainage_rasters")
